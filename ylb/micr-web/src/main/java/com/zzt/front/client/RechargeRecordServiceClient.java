...
public interface RechargeRecordServiceClient {
    /**
     * 根据用户id查询充值记录
     *
     * @param uid
     ...
     * @return
     */
    @GetMapping("/dataservice/rechargerecord/queryrechargerecordbyid")
    List<RechargeRecord> queryRechargeRecordById(@RequestParam("uid") Integer uid, @RequestParam("pageNo") Integer pageNo, @RequestParam("pageSize") Integer pageSize);
