...
public partial class Send : System.Web.UI.Page
{
    ...
    public string merchantAcctId = "1001214035601";
	...
	///编码方式UTF-8 GB2312  用户可以根据自己系统的编码选择对应的加密方式
		...
		//SHA256加签方法可参考文件：SHA256WithRSA.cs
        byte[] bytes = System.Text.Encoding.UTF8.GetBytes(signMsgVal);
        X509Certificate2 cert = new X509Certificate2(HttpContext.Current.Server.MapPath("10012140356.pfx"), "123456", X509KeyStorageFlags.MachineKeySet);
        ...
        SHA256CryptoServiceProvider sha = new SHA1CryptoServiceProvider();
