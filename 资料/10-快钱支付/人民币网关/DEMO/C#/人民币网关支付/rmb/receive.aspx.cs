...
public partial class receive : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //已绑短卡号,信用卡快捷支付绑定卡信息后返回前六后四位信用卡号
         string bindCard = Request.QueryString["bindCard"].ToString();
        //已绑短手机尾号,信用卡快捷支付绑定卡信息后返回前三位后四位手机号码
        string bindMobile= Request.QueryString["bindMobile"].ToString();
        ...
        X509Certificate2 cert = new X509Certificate2(Server.MapPath("CFCA_sandbox.cer"), "");
